...
public class SDB {
    ...
    public static void init(String path, boolean isVM) {
        ...
        try {
            ...
            server.getConfig().ensureTable(HotWord.class, "hotW", "id");
            server.getConfig().ensureIndex(HotWord.class, "hotW", true, "kw");
//            server.getConfig().ensureUpdateIncrementIndex(HotWord.class, "hotW",
//    				"count");
